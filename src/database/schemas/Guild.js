...
const Schema = new mongoose.Schema({
    ...
    prefix: {
        type: String,
        default: PREFIX_COMMANDS.DEFAULT_PREFIX
    },
    ...
    stats: {
        ...
        xp: {
            message: {
                type: String,
                default: STATS.DEFAULT_LVL_UP_MSG
            },
...
module.exports = {
    ...
    getSettings: async (guild) => {
        if (!guild)
            throw new Error('servidor indefinido...');

        if (!guild.id)
            throw new Error('id do servidor indefinido...');
        ...
        if (!guildData) {
            ...
            // criar um model de servidor novo
            guildData = new Model({
                _id: guild.id,
